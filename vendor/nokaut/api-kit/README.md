Nokaut.pl Search API KIT (PHP 5.3 fork)
==============================
...
Tak, podczas budowania obiektu konfiguracji należy ustawić obiekt odpowiedzialny za cache'owanie danych, obiekt ten musi implementować interfejs *Nokaut\ApiKitBB\Cache\CacheInterface*.
