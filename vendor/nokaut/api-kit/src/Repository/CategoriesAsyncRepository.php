...
use Nokaut\ApiKitBB\ClientApi\Rest\Fetch\CategoryFetch;
use Nokaut\ApiKitBB\ClientApi\Rest\Query\CategoriesQuery;
use Nokaut\ApiKitBB\Config;
use Nokaut\ApiKitBB\Converter\Category\CategoriesGrouperConverter;
...
class CategoriesAsyncRepository extends CategoriesRepository implements AsyncRepositoryInterface
{
    ...
    /**
     * @param \Nokaut\ApiKitBB\Config $config
