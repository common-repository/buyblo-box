...
namespace Nokaut\ApiKitBB\ClientApi\Rest;
...
use Nokaut\ApiKitBB\ClientApi\Rest\Exception\FatalResponseException;
use Nokaut\ApiKitBB\ClientApi\Rest\Exception\InvalidRequestException;
use Nokaut\ApiKitBB\ClientApi\Rest\Exception\NotFoundException;
use Nokaut\ApiKitBB\ClientApi\Rest\Exception\UnprocessableEntityException;
...
class RestClientApi implements ClientApiInterface
{
    ...
    protected function sendMultiProcess(Fetches $fetches)
    {
        ...
        foreach ($fetches as $fetch) {
            ...
            $requests[] = $this->getClient()->createRequest(
                ...
                array('exceptions' => false, 'timeout' => self::TIMEOUT, 'connect_timeout' => self::CONNECT_TIMEOUT)
            );
    ...
    protected function sendProcess(Fetch $fetch)
    {
        ...
        $request = $this->getClient()->createRequest(
            ...
            $fetch->getQuery()->getHeaders(),
            $fetch->getQuery()->getBody(),
            array('timeout' => self::TIMEOUT, 'connect_timeout' => self::CONNECT_TIMEOUT)
        );
