...
- zmiana interface \Nokaut\ApiKitBB\Cache\CacheInterface oraz dodanie Nokaut\ApiKitBB\Cache\AbstractCache - jeśli implementowaliście interface CacheInterface wystarczy, że rozszerzycie swoją klasę abstrkcyjną klasą Nokaut\ApiKitBB\Cache\AbstractCache
...
- Nokaut\ApiKitBB\Entity\OfferOffer\Shop - dodanie pola url adresu www do sklepu
- FIX: Nokaut\ApiKitBB\Helper\PhotoUrl - ustawienie domyślnej wartości $additionalUrlPart
- FIX: Nokaut\ApiKitBB\Ext\Data\Converter\Filters\PriceRangesConverter - nazwa filtru gdy jest tylko cena minimalna
...
- RestClientApi: obsługa tokena albo jako string albo jako obiekt implementujący interface \Nokaut\ApiKitBB\ClientApi\Rest\Auth\AuthHeader
...
------
 ...
 - Query: metodę Nokaut\ApiKitBB\ClientApi\Rest\Query\ProductsQuery::addFilter($filter, $searchValue) zastąpiła metoda Nokaut\ApiKitBB\ClientApi\Rest\Query\QueryBuilderAbstract::addFilter(Filter\FilterInterface $filter)
 - Dodanie metody toHash() do Nokaut\ApiKitBB\ClientApi\ClientApiInterface
